...
# Display the summary table
kable(clustering_summary, caption = "Summary of Clustering Methods and Optimal Clusters", format = "latex", booktabs = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 10) %>%
...
kable(concise_recommendations, caption = "Recommended Counties Based on Clustering Analysis", format = "latex", booktabs = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 10) %>%
